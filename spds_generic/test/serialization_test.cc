...
int main()
{
    ...
    {
        spds_generic::Control c1(0.1, 0.2);
        spds_generic::Control c2(0.3, 0.4);
        spds_generic::Pose2d p(1., 2., 3.);
        ...
        // Load
        spds_generic::Control c1_restored, c2_restored;
        spds_generic::Pose2d p_restored;
        {
    ...
    }
    {
        ...
        spds_generic::Path path = spds_generic::loadPathTextFile(txt_file_name.c_str());
        ...
        spds_generic::Pose2dVec pvec(path);
        {
        ...
        // Load
        spds_generic::Pose2dVec pvec_restored;
        {
        ...
        // Load
        spds_generic::Path path_restored;
        {
            std::cout << " loading : " << file_name << std::endl;
            std::ifstream ifs(file_name.c_str());
            boost::archive::text_iarchive ar(ifs);
    ...
    {
        spds_generic::CoordinatedTimes ct(10);
        ct[0] = 10.;
        ...
        // Load
        spds_generic::CoordinatedTimes ct_restored;
        {
            std::cout << " loading : " << file_name << std::endl;
            std::ifstream ifs(file_name.c_str());
            boost::archive::text_iarchive ar(ifs);
...

    {
        ...
        // Load
        spds_generic::Point2dVec pv_restored;
        {
            std::cout << " loading : " << file_name << std::endl;
            std::ifstream ifs(file_name.c_str());
            boost::archive::text_iarchive ar(ifs);
