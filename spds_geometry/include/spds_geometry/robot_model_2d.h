...
namespace spds_geometry {
  ...
  public:
     ...
     */
    virtual const Polygon& getBoundingRegion(const spds_generic::RobotInternalState2d &s) const = 0;
  };
  ...
  public:
    ...
    virtual const Polygon& getBoundingRegion(const spds_generic::RobotInternalState2d &s) const {
      switch (s.loadType) {
      case spds_generic::RobotInternalState2d::NO_LOAD: 
	return wo_load;
	break;
      case spds_generic::RobotInternalState2d::EUR_PALLET:
	// TODO!!!!
	return w_load;
	break;
      case spds_generic::RobotInternalState2d::HALF_PALLET:
	// TODO!!!!
	return w_load2;
	break;
      default:
...
//      bound.points.push_back(Eigen::Vector2d(-0.165, 0.25));
  ...
  private:
    spds_geometry::RobotModel2dSnowWhite model1;
    spds_geometry::RobotModel2dCiTiTruck model2;
    spds_geometry::RobotModel2dOneSquareMeter model3;
    spds_geometry::RobotModel2dPitViper model4;
    spds_geometry::RobotModel2dXa15 model5;
    spds_geometry::RobotModel2dHRP model6;
    spds_geometry::RobotModel2dBtTruck model7;
  };

  class RobotModel2dWithState : public spds_generic::Point2dContainerInterface, public spds_generic::Point2dCollisionCheckInterface {
  public:
    ...
    void update(const spds_generic::Pose2d &p, const spds_generic::RobotInternalState2d &is);
    const Polygon& getPosePolygon() const { return posePolygon; }
    const spds_generic::Pose2d& getRobotPose() const { return robotPose; }
    void getBoundingBox(Eigen::Vector2d &bottomLeft, Eigen::Vector2d &topRight) const {
      spds_geometry::getBoundingBox2d(this->posePolygon, bottomLeft, topRight);
    }

  private:
    const RobotModel2dInterface& model;
    Polygon posePolygon;
    spds_generic::Pose2d robotPose;
  };
