...
#include <spds_geometry/serialization.h>
...
{
  {
    spds_generic::Point2dVec pts, pts2, pts3;
    ...
    spds_geometry::Polygon p(pts);
    spds_geometry::Polygon p2(pts2);
    ...
    // Load
    {    spds_geometry::Polygon p4_restored;
